package com.umutg.bitaksicaseapp.data.remote.dto


import com.google.gson.annotations.SerializedName
import com.umutg.bitaksicaseapp.domain.model.Plane

data class PlaneStatesDto(
...
fun PlaneStatesDto.toPlaneList(): List<Plane> {
    ...
    states.forEach { item ->
        ...
        val plane = Plane(
            icao24 = item[0].toString(),
            callsign = item[1].toString(),
            originCountry = item[2].toString(),
            timePosition = item[3].toString().toDouble(),
            longitude = item[5].toString().toDouble(),
            latitude = item[6].toString().toDouble(),
            baroAltitude = item[7].toString().toDouble()
        )
